...
app=Flask(__name__,template_folder='apihtml')
app.config['SECRET_KEY'] = "raheejan"
...
class flowerform(FlaskForm):
    ...
    pet_width = TextField("pet width",validators=[DataRequired(),Length(min=1,max=4)])
...
def predictions():
    ...
    return  render_template('predictions.html',reslt=flower)
